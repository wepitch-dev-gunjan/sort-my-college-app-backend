...
const { getProfile, editProfile, getInstitutesForAdmin, getInstituteForAdmin, editInstituteForAdmin, deleteInstituteForAdmin } = require('../controllers/entranceInstituteControllers');
...
router.delete('/institute/admin/:institute_id', adminAuth, deleteInstituteForAdmin);
